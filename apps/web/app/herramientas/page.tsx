...
const tools = [
  { title: 'Centros Premium', description: 'MathLab, Ciencias Vivas, caligrafía, grafomotricidad, pictogramas y Plan Lector con fotografía educativa real.', icon: Shapes, href: '/centros-premium', status: 'Premium', featured: true },
  ...
  { title: 'Caligrafía y grafomotricidad', description: 'Crea trazos, palabras, pautas y actividades listas para imprimir.', icon: PenTool, href: '/centros-premium', status: 'Integrado' },
  { title: 'Manipulativos matemáticos', description: 'Base diez, fracciones, dinero, geometría y representaciones visuales.', icon: Shapes, href: '/centros-premium', status: 'Integrado' },
  { title: 'Pictogramas y apoyos visuales', description: 'Rutinas, secuencias, tableros y comunicación visual.', icon: Image, href: '/centros-premium', status: 'Integrado' },
