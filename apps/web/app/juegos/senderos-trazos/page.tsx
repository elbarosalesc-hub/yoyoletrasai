...
import SenderosTrazos3D from '@/components/games/SenderosTrazos3D'

export default function SenderosTrazosPage(){
 ...
 return <AppShell active="Juegos 3D"><SenderosTrazos3D reducedMotion={reduced} highContrast={contrast} audioEnabled={audio}/></AppShell>
}
