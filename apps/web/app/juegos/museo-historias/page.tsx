...
import MuseoHistorias3D from '@/components/games/MuseoHistorias3D'

export default function MuseoHistoriasPage(){
 ...
 return <AppShell active="Juegos 3D"><MuseoHistorias3D reducedMotion={reduced} highContrast={contrast} audioEnabled={audio}/></AppShell>
}
