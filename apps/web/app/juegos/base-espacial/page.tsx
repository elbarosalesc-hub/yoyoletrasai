...
import BaseEspacial3D from '@/components/games/BaseEspacial3D'

export default function BaseEspacialPage(){
 ...
 return <AppShell active="Juegos 3D"><BaseEspacial3D reducedMotion={reduced} highContrast={contrast} audioEnabled={audio}/></AppShell>
}
