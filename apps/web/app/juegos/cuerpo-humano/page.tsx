...
import ExpedicionCuerpoHumano3D from '@/components/games/ExpedicionCuerpoHumano3D'
...
export default function CuerpoHumanoPage(){
 ...
 return <AppShell active="Juegos 3D"><ExpedicionCuerpoHumano3D reducedMotion={reduced} highContrast={contrast} audioEnabled={audio}/></AppShell>
}
