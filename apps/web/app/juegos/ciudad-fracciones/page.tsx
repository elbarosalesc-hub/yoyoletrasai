...
import CiudadFracciones3D from '@/components/games/CiudadFracciones3D'

export default function CiudadFraccionesPage(){
 ...
 return <AppShell active="Juegos 3D"><CiudadFracciones3D reducedMotion={reduced} highContrast={contrast} audioEnabled={audio}/></AppShell>
}
