...
function DailySummary({mobile=false}:{mobile?:boolean}){return <aside className={`summary-card premium-card ${mobile?'summary-mobile':'summary-desktop'}`}><div className="summary-head"><h2>Resumen del día</h2><span>Hoy</span></div><div className="summary-grid"><div className="summary-stat violet"><Users/><strong>28</strong><span>estudiantes de 32 activos</span></div><div className="summary-stat mint"><Target/><strong>15</strong><span>actividades realizadas</span></div><div className="summary-stat cyan"><Clock3/><strong>2h 35m</strong><span>tiempo de aprendizaje</span></div><div className="summary-stat yellow"><Trophy/><strong>12</strong><span>logros obtenidos</span></div></div></aside>}
