...
import { Bot, FileSearch, Loader2, ShieldCheck, Sparkles, Upload } from 'lucide-react'
      ...
      <section className="approved-main-grid">
        <article className="approved-panel" style={{padding:24}}>
          ...
          <form onSubmit={submit} style={{display:'grid',gap:16}}>
            ...
            <textarea value={prompt} onChange={(event)=>setPrompt(event.target.value)} required rows={10} placeholder="Ejemplo: crea una evaluación de Matemática para 5° básico alineada al currículum chileno, con DUA, rúbrica y pauta de corrección..." style={{width:'100%',border:'1px solid #dde2ec',borderRadius:18,padding:18,font:'inherit',resize:'vertical'}} />
        ...
        <aside className="approved-panel" style={{padding:24}}>
          ...
          <div className="approved-readiness">
            ...
            <div><span><FileSearch/></span><div><strong>Investigación y análisis</strong><small>Fuentes confiables y trazabilidad obligatoria</small></div></div>
