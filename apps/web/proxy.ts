...
const teacherRoutes=['/app','/biblioteca','/crear','/yoyo','/cursos','/estudiantes','/contenidos','/planificacion','/tareas','/evaluaciones','/portafolios','/recursos-pie','/juegos','/estudio-inmersivo','/profesor-virtual','/audio','/multimedia','/gamificacion','/calendario','/informes','/analitica','/comunicaciones','/apoderados','/notificaciones','/configuracion','/usuarios','/permisos','/auditoria']
